  ...
  experience: [
    {
      ...
      description: "Desarrollo de un sistema integral de gestión clínica diseñado para optimizar el registro y seguimiento de pacientes."
    },
    {
      role: "Desarrollador de Software Médico",
      company: "Proyecto OneViewer - LANIG",
      period: "Pasado/Actual",
      description: "Desarrollo y optimización de un ecosistema de visualización de imágenes médicas (PACS/DICOM). Enfoque en la interoperabilidad y el rendimiento clínico del sistema."
    },
    {
      role: "Desarrollador Frontend/Mobile",
      company: "Tienda Isabel",
      period: "Finalizado",
      description: "Desarrollo de una aplicación multiplataforma utilizando Ionic y Angular. Implementación de Firebase para gestión de inventario en tiempo real y reportes. Creación de un sistema de pago mediante código QR."
    }
  ],
  education: [
    {
